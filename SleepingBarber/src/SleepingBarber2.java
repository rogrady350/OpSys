...
public class SleepingBarber2 extends Thread {
	...
	class Barber extends Thread {
	  private String name; //h. barber name
		
	  //h. modify barber constructor to show barber's names
	  ...
	  public void cutHair(){
		System.out.println(name + " is cutting hair");	//h. add barber's name
	    try {
	      sleep(5000);
	    } catch (InterruptedException ex){ }
	  }
	  ...
	  //h. add 2 more barbers
	  public void run(){   
	   Barber giovanni = new Barber("Giovanni");  //Giovanni is the best barber ever 
	   giovanni.start();  //Ready for another day of work
	   
	   Barber mario = new Barber("Mario");  //Mario also is the best barber ever
	   mario.start(); //Ready for another day of work
	   
	   Barber giuseppe = new Barber("Giuseppe");  //Giuseppe is also the best barber ever 
	   giuseppe.start(); //Ready for another day of work
